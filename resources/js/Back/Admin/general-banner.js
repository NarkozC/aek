var vars = {
    ...
    sectionControllers: {
        ...
        Portal: baseurl + 'Portal/Admin/Banner/',
    },
    sectionNames: {
        Normal: 'Banner',
        Upper: 'Banner',
...
function GetSectionsNum() {
    $('#' + vars.sectionShowBases.Num).html(vars.sectionDatas.Banner.Num);
}
