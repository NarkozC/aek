var vars = {
    ...
    sectionControllers: {
        ...
        Portal: baseurl + 'Portal/Admin/Galeriler/',
    },
    sectionNames: {
        Normal: 'Galeriler',
        Upper: 'Galeriler',
    ...
    sectionFunctions: {
        Get: 'GetGaleriler',
        Add: 'AddGaleriler',
        Update: 'UpdateGaleriler',
        Edit: 'EditGaleriler',
        Delete: 'DeleteGaleriler',
    },
    sectionButtons: {
        OpenModal: 'GalerilerOpenModal',
        Submit: 'GalerilerSubmit',
    },
    sectionDatas: {
        Galeriler: {
            Data: new Array(),
...
function GetSectionsNum() {
    $('#' + vars.sectionShowBases.Num).html(vars.sectionDatas.Galeriler.Num);
}
