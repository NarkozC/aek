    ...
    if(! $this->input->is_ajax_request()) {
      ...
      if($this->session->userdata('logged_in') && $this->session->userdata('Admin')) {
        ...
        if ($en == "true") {
          ...
          $this->form_validation->set_rules('Sayfa', FORM_LANG_EN['Sayfa'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
          if ($sayfa == "kadro" || $sayfa == "yonetim-kurulu" || $sayfa == "okul-aile-birligi") {
             ...
             $this->form_validation->set_rules('GrupSectionID', FORM_LANG_EN['GrupSectionID'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
             $this->form_validation->set_rules('Aciklama', FORM_LANG_EN['Aciklama'], 'required|trim|max_length[255]|strip_tags|xss_clean');
          ...
          if ($sayfa == "yonetim-kurulu") {
            $this->form_validation->set_rules('tr_UzunAciklama', FORM_LANG_EN['UzunAciklama'], 'required|trim|max_length[255]|strip_tags|xss_clean');
            $this->form_validation->set_rules('en_UzunAciklama', FORM_LANG_EN['UzunAciklama'], 'trim|max_length[255]|strip_tags|xss_clean');
          }
          ...
          $this->form_validation->set_rules('Sayfa', FORM_LANG_TR['Sayfa'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
          if ($sayfa == "kadro" || $sayfa == "yonetim-kurulu" || $sayfa == "okul-aile-birligi") {
             $this->form_validation->set_rules('AdSoyad', FORM_LANG_TR['AdSoyad'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
             $this->form_validation->set_rules('GrupSectionID', FORM_LANG_TR['GrupSectionID'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
             $this->form_validation->set_rules('Aciklama', FORM_LANG_TR['Aciklama'], 'required|trim|max_length[255]|strip_tags|xss_clean');
             $this->form_validation->set_rules('Resim', FORM_LANG_TR['Resim'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
          }
          if ($sayfa == "yonetim-kurulu") {
            $this->form_validation->set_rules('tr_UzunAciklama', FORM_LANG_TR['UzunAciklama'], 'required|trim|max_length[255]|strip_tags|xss_clean');
            $this->form_validation->set_rules('en_UzunAciklama', FORM_LANG_TR['UzunAciklama'], 'trim|max_length[255]|strip_tags|xss_clean');
          }
          if ($sayfa == "okul-aile-birligi-galeri") { 
            $this->form_validation->set_rules('GrupSectionID', FORM_LANG_TR['GrupSectionID'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
            $this->form_validation->set_rules('Aciklama', FORM_LANG_TR['Aciklama'], 'required|trim|max_length[255]|strip_tags|xss_clean');
  ...
  public function AddKadroGrup(){
    if(! $this->input->is_ajax_request()) {
      ...
      if($this->session->userdata('logged_in') && $this->session->userdata('Admin')) {
        ...
        if ($en == "true") {
          $this->config->set_item('language', FORM_LANGUAGES['Ingilizce']);
          $this->form_validation->set_rules('MainOrSub', FORM_LANG_EN['MainOrSub'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
          $this->form_validation->set_rules('MainSectionID', FORM_LANG_EN['MainSectionID'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
          $this->form_validation->set_rules('tr_KisaAd', FORM_LANG_EN['KisaAd'], 'required|trim|max_length[255]|strip_tags|xss_clean');
          $this->form_validation->set_rules('en_KisaAd', FORM_LANG_EN['KisaAd'], 'trim|max_length[255]|strip_tags|xss_clean');
          $this->form_validation->set_rules('tr_Ad', FORM_LANG_EN['Ad'], 'trim|max_length[255]|strip_tags|xss_clean'); 
          $this->form_validation->set_rules('en_Ad', FORM_LANG_EN['Ad'], 'trim|max_length[255]|strip_tags|xss_clean'); 
        } else {
          $this->form_validation->set_rules('MainOrSub', FORM_LANG_TR['MainOrSub'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
          $this->form_validation->set_rules('MainSectionID', FORM_LANG_TR['MainSectionID'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
          $this->form_validation->set_rules('tr_KisaAd', FORM_LANG_TR['KisaAd'], 'required|trim|max_length[255]|strip_tags|xss_clean');
          $this->form_validation->set_rules('en_KisaAd', FORM_LANG_TR['KisaAd'], 'trim|max_length[255]|strip_tags|xss_clean');
          $this->form_validation->set_rules('tr_Ad', FORM_LANG_TR['Ad'], 'trim|max_length[255]|strip_tags|xss_clean'); 
