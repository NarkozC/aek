...
function CreateHtml() {
    ...
    var html = '<div class="container padding0">' +
        '<div class="col-xs-12 col-sm-6 col-md-5 col-lg-4 text-center padding0" style="position: absolute;left: 50%;top: 35%;-webkit-transform: translate(-50%, -50%);transform: translate(-50%, -50%);">' +
        '<div id="theContainer">' +
