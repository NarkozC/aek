var vars = {
    ...
    sectionControllers: {
        ...
        Portal: baseurl + 'Portal/Admin/Kurucu-Mesaji/',
    },
    sectionNames: {
    ...
    sectionFunctions: {
        Get: 'GetKurucuMesaji',
        Add: 'AddKurucuMesaji',
        Update: 'UpdateKurucuMesaji',
        Edit: 'EditKurucuMesaji',
        Delete: 'DeleteKurucuMesaji',
        Up: 'UpKurucuMesaji',
        Down: 'DownKurucuMesaji',
    },
    sectionButtons: {
        OpenModal: 'KurucuMesajiOpenModal',
        Submit: 'KurucuMesajiSubmit',
    },
    sectionDatas: {
        KurucuMesaji: {
            Data: new Array(),
...
function GetSectionsNum() {
    $('#' + vars.sectionShowBases.Num).html(vars.sectionDatas.KurucuMesaji.Num);
}
...
function GetSectionsData() {
    vars.sectionDatas.KurucuMesaji = {
        Data: new Array(),
        FHtml: '',
        BHtml: '',
        Num: 0,
