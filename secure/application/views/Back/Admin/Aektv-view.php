...
<html lang="tr">
<head>
    <title>Ankara Eğitim Kurumları Tanıtım Videosu | Admin AEK</title>
...
<div id="showAektv"></div>

<script type="text/javascript" src="<?php echo base_url(); ?>resources/js/Back/Admin/general-aektv.js"></script>
