...
class Ajax_pagination{
    ...
    var $first_link      = 'İlk';
    var $next_link       = '<i class="fa fa-lg fa-arrow-circle-o-right" aria-hidden="true"></i>';
    var $prev_link       = '<i class="fa fa-lg fa-arrow-circle-o-left" aria-hidden="true"></i>';
    var $last_link       = 'Son';
    var $uri_segment     = 3;
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = 'Gösteriliyor : ' . $this->total_rows;
            return $info;
        }
