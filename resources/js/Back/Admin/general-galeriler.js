var vars = {
    form: 'form',
    modal: 'modal',
    sectionNameNormal: 'Galeriler',
    sectionNameLower: 'galeriler',
    sectionNameUpper: 'Galeriler',
    sectionPortalController: baseurl + 'Portal/Admin/Galeriler/',
    sectionController: baseurl + 'Galeriler/',
    sectionShowBase: '.panel-body',
    sectionGetFunction: 'GetGaleriler',
    sectionAddFunction: 'AddGaleriler',
    sectionUpdateFunction: 'UpdateGaleriler',
    sectionEditFunction: 'EditGaleriler',
    sectionDeleteFunction: 'DeleteGaleriler',
    sectionNumFunction: 'GetGalerilerNum',
    sectionOpenModalButton: 'GalerilerOpenModal',
    sectionAddUpdateSubmitButton: 'GalerilerAddUpdateSubmit',
