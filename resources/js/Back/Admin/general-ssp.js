var vars = {
    ...
    sectionControllers: {
        Normal: baseurl + 'Ssp/',
        Portal: baseurl + 'Portal/Admin/Ssp/',
    },
    sectionNames: {
        Normal: 'Sosyal Sorumluluk Projeleri',
        Upper: 'Ssp',
        Lower: 'ssp',
        Kod: 'GSSP',
    },
...
function GetSectionsNum() {
    $('#' + vars.sectionShowBases.Num).html(vars.sectionDatas.Ssp.Num);
}
...
function CreateSectionsTable() {
    ...
    $('#show' + vars.sectionNames.Upper + 'Data').html(vars.sectionDatas.Ssp.BHtml);
        ...
        success: function(result) {
            if (en && result.cachedataEN != "") {
                ...
                for (i = 0; i < length; i++) {
                    ...
                    vars.sectionDatas.Ssp.Data[i] = curData;
                ...
                vars.sectionDatas.Ssp.BHtml = bHtml;
                vars.sectionDatas.Ssp.FHtml = fHtml;
                vars.sectionDatas.Ssp.Num = length;
