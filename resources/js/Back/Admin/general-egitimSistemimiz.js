var vars = {
    ...
    sectionControllers: {
        ...
        Portal: baseurl + 'Portal/Admin/Egitim-Sistemimiz/',
    },
    sectionNames: {
        Normal: 'Eğitim Sistemimiz',
        Upper: 'EgitimSistemimiz',
        Lower: 'egitimSistemimiz',
        Kod: 'GES',
    },
    sectionShowBases: {
        Sections: 'showEgitimSistemimiz',
        Num: 'showNum',
        Modal: 'showSectionsModal',
    },
    sectionFunctions: {
        Get: 'GetEgitimSistemimiz',
        Add: 'AddEgitimSistemimiz',
        Update: 'UpdateEgitimSistemimiz',
        Edit: 'EditEgitimSistemimiz',
        Delete: 'DeleteEgitimSistemimiz',
        Up: 'UpEgitimSistemimiz',
        Down: 'DownEgitimSistemimiz',
    },
    sectionButtons: {
        OpenModal: 'EgitimSistemimizOpenModal',
        Submit: 'EgitimSistemimizSubmit',
    },
    sectionDatas: {
        EgitimSistemimiz: {
            Data: new Array(),
...
function GetSectionsNum() {
    $('#' + vars.sectionShowBases.Num).html(vars.sectionDatas.EgitimSistemimiz.Num);
}
...
function CreateSectionsTable() {
    ...
    $('#show' + vars.sectionNames.Upper + 'Data').html(vars.sectionDatas.EgitimSistemimiz.BHtml);
...
function GetSectionsData() {
    vars.sectionDatas.EgitimSistemimiz = {
        Data: new Array(),
        FHtml: '',
        BHtml: '',
        Num: 0,
        ...
        success: function(result) {
            if (en && result.cachedataEN != "") {
                ...
                for (i = 0; i < length; i++) {
                    ...
                    vars.sectionDatas.EgitimSistemimiz.Data[i] = curData;
                }
                fhtml += '</section>';
