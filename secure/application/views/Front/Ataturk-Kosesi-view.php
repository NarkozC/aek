...
<html lang="tr">
<head>
  <title>Atatürk Köşesi | AEK</title>
  <!--<meta name="keywords" content="koçluk, öğrenci, yönetici, takım, ilişki">-->

<?php $this->view('Front/front-navbar.php'); ?>


<section id="ataturkKosesi">
  <div class="container wow bounceInDown">
    <div class="col-lg-12 page-header paddingL0">
      <h2 data-basliklar="GAK">Atatürk Köşesi</h2>
    </div>
  </div>
  <div class="container wow bounceInUp dark-bg shadow borderRad10">
	  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	  	<p>
	  		<!-- Resim 1 gelecek sol tarafa -->
	  		<img src="<?php echo base_url(); ?>resources/images/Genel/Ataturk-Kosesi-2.jpg" class="img-responsive hidden-xs" alt="Image" style="float: left; max-width: 300px; margin-right: 10px;margin-bottom: 10px;">
	  		<img src="<?php echo base_url(); ?>resources/images/Genel/Ataturk-Kosesi-2.jpg" class="img-responsive visible-xs img-center" alt="Image" style=" max-width: 300px;margin-bottom: 10px;">
	  		...
	  		<br>
	  		<!-- Resim 2 gelecek sağ tarafa -->
	  		<img src="<?php echo base_url(); ?>resources/images/Genel/Ataturk-Kosesi-3.jpg" class="img-responsive hidden-xs" alt="Image" style="float: right; max-width: 300px;margin-bottom: 10px;margin-top: 10px;margin-left: 10px;">
	  		<img src="<?php echo base_url(); ?>resources/images/Genel/Ataturk-Kosesi-3.jpg" class="img-responsive visible-xs img-center" alt="Image" style=" max-width: 300px;margin-bottom: 10px;margin-top: 10px;">
	  		<ol>
	  			<li>
