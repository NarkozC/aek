        ...
        if(! $this->input->is_ajax_request()) {
            ...
            if($this->session->userdata('logged_in') && $this->session->userdata('Admin')) {
                ...
                if ($en == "true") {
                    ...
                    $this->form_validation->set_rules('IsLink', "", 'trim|max_length[255]|strip_tags|xss_clean');
                    $this->form_validation->set_rules('IsLinkInBaseurl', "", 'trim|max_length[255]|strip_tags|xss_clean');
                    $this->form_validation->set_rules('Link', "", 'trim|max_length[255]|strip_tags|xss_clean');
                    $this->form_validation->set_rules('Level', "", 'required|trim|max_length[255]|strip_tags|xss_clean'); 
                    $this->form_validation->set_rules('MainSectionID', "", 'trim|max_length[255]|strip_tags|xss_clean'); 
                } else {
                    $this->form_validation->set_rules('tr_Ad', "", 'required|trim|max_length[255]|strip_tags|xss_clean'); 
                    $this->form_validation->set_rules('en_Ad', "", 'trim|max_length[255]|strip_tags|xss_clean'); 
                    $this->form_validation->set_rules('IsLink', "", 'trim|max_length[255]|strip_tags|xss_clean');
