    ...
    if(! $this->input->is_ajax_request()) {
      ...
      if($this->session->userdata('logged_in') && $this->session->userdata('Admin')) {
        ...
        if ($en == "true") {
          ...
          $this->form_validation->set_rules('tr_Resim', FORM_LANG_EN['AnaResim'], 'required|trim|max_length[255]|strip_tags|xss_clean');

          $this->form_validation->set_rules('en_Baslik', FORM_LANG_EN['Baslik'], 'trim|max_length[255]|strip_tags|xss_clean');       
          $this->form_validation->set_rules('en_Resim', FORM_LANG_EN['AnaResim'], 'trim|max_length[255]|strip_tags|xss_clean');
          ...
          $this->form_validation->set_rules('tr_Resim', FORM_LANG_TR['AnaResim'], 'required|trim|max_length[255]|strip_tags|xss_clean');

          $this->form_validation->set_rules('en_Baslik', FORM_LANG_TR['Baslik'], 'trim|max_length[255]|strip_tags|xss_clean');       
          $this->form_validation->set_rules('en_Resim', FORM_LANG_TR['AnaResim'], 'trim|max_length[255]|strip_tags|xss_clean');
