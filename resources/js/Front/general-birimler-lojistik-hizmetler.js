$(function(){
  GetBirimlerLojistikHizmetler();
});

function GetBirimlerLojistikHizmetler(){
    var url = baseurl+'Birimler/GetBirimlerLojistikHizmetler';
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        html += '</div>';
        $('#showBirimlerLojistikHizmetler').html(html);
      },
      error: function(){
        if (en) {
          iziError();
