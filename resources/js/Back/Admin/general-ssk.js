var vars = {
    ...
    sectionControllers: {
        Normal: baseurl + 'Ssk/',
        Portal: baseurl + 'Portal/Admin/Ssk/',
    },
    sectionNames: {
...
function GetSectionsNum() {
    $('#' + vars.sectionShowBases.Num).html(vars.sectionDatas.Ssk.Num);
}
...
function CreateSectionsTable() {
    ...
    $('#show' + vars.sectionNames.Upper + 'Data').html(vars.sectionDatas.Ssk.BHtml);
