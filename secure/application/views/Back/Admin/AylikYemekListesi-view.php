...
<html lang="tr">
<head>
    <title>Aylık Yemek Listesi | Admin AEK</title>
...
<script type="text/javascript" src="<?php echo base_url(); ?>resources/js/Back/Admin/general-aylikYemekListesi.js"></script>
