...
$(function(){
  ...
  function GetGaleriler(){
    var url = baseurl+'Galeriler/GetGaleriler';
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        html += '<section id="haberler">'+
                ...
                '<h2 data-basliklar="GH">Galeriler</h2>'+
                '</div>';
        for(i=0; i<data.length; i++){
          if (en) {
            ...
            Link = baseurl+'en/Galeriler/Galeri/'+SectionID;
            ...
            Yazi = data[i].tr_Yazi;
            SectionID = data[i].tr_SectionID;
            Link = baseurl+'Galeriler/Galeri/'+SectionID;
          }
          Tarih = data[i].Tarih;
  ...
  function GetGaleri(){
    var url = baseurl+'Galeriler/GetGaleri';
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        html += '<section id="haberlerA">'+
                ...
                '<a href="'+baseurl+'Galeriler"><h3 data-basliklar="GH" class="page-header">Galeriler</h3></a>'+
                '</div>';
        ...
        html += '<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">'+
                ...
                '<a href="'+baseurl+'Galeriler"><button type="button" class="btn btn-danger btn-md">'+btnTum+' <span data-basliklar="GH">Galeriler</span></button></a>'+
                '</div>'+
                '</div>'+
                '</div>'+
                '</section>';
        $('#showGalerilerA').html(html);
      },
      error: function(){
        if (en) {
          iziError();
