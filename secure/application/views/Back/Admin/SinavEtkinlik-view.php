...
<head>
    ...
    <title>Sınav - Etkinlik | Admin AEK</title>
...
<div id="showSinavEtkinlik"></div>

<script type="text/javascript" src="<?php echo base_url(); ?>resources/js/Back/Admin/general-sinav-etkinlik.js"></script>
