var vars = {
    ...
    sectionControllers: {
        Normal: baseurl + 'Ipc/',
        Portal: baseurl + 'Portal/Admin/Ipc/',
    },
    sectionNames: {
        Normal: 'International Premier College',
        Upper: 'Ipc',
        Lower: 'ipc',
        Kod: 'GIPC',
    },
...
function GetSectionsNum() {
    $('#' + vars.sectionShowBases.Num).html(vars.sectionDatas.Ipc.Num);
}
        ...
        success: function(result) {
            if (en && result.cachedataEN != "") {
                ...
                for (i = 0; i < length; i++) {
                    ...
                    vars.sectionDatas.Ipc.Data[i] = curData;
                ...
                vars.sectionDatas.Ipc.BHtml = bHtml;
                vars.sectionDatas.Ipc.FHtml = fHtml;
                vars.sectionDatas.Ipc.Num = length;
