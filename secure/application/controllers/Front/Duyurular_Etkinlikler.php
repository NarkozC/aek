...
class Duyurular_Etkinlikler extends CI_Controller {
	...
	public function GetDuyurularEtkinlikler(){
		if(! $this->input->is_ajax_request()) {
			...
			$cacheKeyTR = $this->data['cacheKeys']['GetDuyurularEtkinliklerTR'];
            $cacheKeyEN = $this->data['cacheKeys']['GetDuyurularEtkinliklerEN'];
			$this->data['English'] = $this->input->post('English');
			$this->data['NeedData'] = $this->input->post('NeedData');

			if ($this->data['NeedData'] == "true") {
				$this->data['data'] = $this->General_Model->GetDuyurularEtkinlikler();
			} else {
