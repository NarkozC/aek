var vars = {
    ...
    sectionControllers: {
        ...
        Portal: baseurl + 'Portal/Admin/Uluslararasi-Projeler/',
    },
    sectionNames: {
    ...
    sectionFunctions: {
        ...
        Add: 'AddUluslararasiProjeler',
        Update: 'UpdateUluslararasiProjeler',
        Edit: 'EditUluslararasiProjeler',
        Delete: 'DeleteUluslararasiProjeler',
        Up: 'UpUluslararasiProjeler',
        Down: 'DownUluslararasiProjeler',
    },
    sectionButtons: {
        OpenModal: 'UluslararasiProjelerOpenModal',
        Submit: 'UluslararasiProjelerSubmit',
    },
    sectionDatas: {
...
function GetSectionsNum() {
    $('#' + vars.sectionShowBases.Num).html(vars.sectionDatas.UluslararasiProjeler.Num);
}
...
function CreateSectionsTable() {
    ...
    $('#show' + vars.sectionNames.Upper + 'Data').html(vars.sectionDatas.UluslararasiProjeler.BHtml);
...
function GetSectionsData() {
    vars.sectionDatas.UluslararasiProjeler = {
        Data: new Array(),
        FHtml: '',
        BHtml: '',
        Num: 0,
    ...
    $.ajax({
        ...
        success: function(result) {
            if (en && result.cachedataEN != "") {
                ...
                vars.sectionDatas.UluslararasiProjeler.Data = JSON.parse(cache.Data);
                ...
                var myJSON = JSON.stringify(vars.sectionDatas.UluslararasiProjeler.Data);
                vars.sectionDatas.UluslararasiProjeler.Data = myJSON;
                var theCacheData = {
                    UluslararasiProjeler: vars.sectionDatas.UluslararasiProjeler,
                }
                setTimeout(Cache('GetSectionsData', url, theCacheData), 1);
                vars.sectionDatas.UluslararasiProjeler.Data = JSON.parse(myJSON);
            }
        },
        error: function() {
            iziError();
