var vars = {
    ...
    sectionControllers: {
        ...
        Portal: baseurl + 'Portal/Admin/Hakkimizda/',
    },
    sectionNames: {
        Normal: 'Hakkımızda',
        Upper: 'Hakkimizda',
    ...
    sectionFunctions: {
        Get: 'GetHakkimizda',
        Add: 'AddHakkimizda',
        Update: 'UpdateHakkimizda',
        Edit: 'EditHakkimizda',
        Delete: 'DeleteHakkimizda',
        Up: 'UpHakkimizda',
        Down: 'DownHakkimizda',
    },
    sectionButtons: {
        OpenModal: 'HakkimizdaOpenModal',
        Submit: 'HakkimizdaSubmit',
    },
    sectionDatas: {
        Hakkimizda: {
            Data: new Array(),
...
function GetSectionsNum() {
    $('#' + vars.sectionShowBases.Num).html(vars.sectionDatas.Hakkimizda.Num);
}
