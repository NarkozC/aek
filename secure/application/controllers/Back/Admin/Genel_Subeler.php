    ...
    if(! $this->input->is_ajax_request()) {
      ...
      if($this->session->userdata('logged_in') && $this->session->userdata('Admin')) {
        ...
        if ($en == "true") {
          ...
          $this->form_validation->set_rules('Kod', FORM_LANG_EN['Kod'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
        } else {
          $this->form_validation->set_rules('Okul', FORM_LANG_EN['Okul'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
          $this->form_validation->set_rules('Sinif', FORM_LANG_EN['Sinif'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
          $this->form_validation->set_rules('Kod', FORM_LANG_EN['Kod'], 'required|trim|max_length[255]|strip_tags|xss_clean');       
        ...
        if ($this->form_validation->run()) {
          ...
          if ($result) {
            ...
            $this->data['data'] = $this->General_Model->EditSubeler('0');
    ...
    if(! $this->input->is_ajax_request()) {
      ...
      if($this->session->userdata('logged_in') && $this->session->userdata('Admin')) {
        ...
        if ($en == "true") {
          ...
          $this->form_validation->set_rules('Sinif', FORM_LANG_TR['Sinif'], 'required|trim|max_length[255]|strip_tags|xss_clean'); 
          $this->form_validation->set_rules('Kod', FORM_LANG_TR['Kod'], 'required|trim|max_length[255]|strip_tags|xss_clean');     
        }
        $this->form_validation->set_error_delimiters('<p class="text-danger">', '</p>');
        if ($this->form_validation->run()) {
